...
namespace OpenSettings.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterProviderServices(this IServiceCollection services, OpenSettingsConfiguration openSettingsConfiguration)
        {
            ...
            services.AddScoped<IAppSqlService, AppSqlService>();
            services.AddScoped<IAppTagMappingSqlService, AppTagMappingSqlService>();
            services.AddScoped<IAppConfigurationSqlService, AppConfigurationSqlService>();
            services.AddScoped<IIdentifierSqlService, IdentifierSqlService>();
            services.AddScoped<IAppInstanceSqlService, AppInstanceSqlService>();
            ...
            services.AddScoped<IAppSettingClassSqlService, AppSettingClassSqlService>();
            services.AddScoped<IAppSettingHistorySqlService, AppSettingHistorySqlService>();
            services.AddScoped<IAppSettingSqlService, AppSettingSqlService>();
            services.AddScoped<ISortOrderSqlService, SortOrderSqlService>();
            services.AddScoped<IAppTagSqlService, AppTagSqlService>();
        ...
        private static void RegisterConsumerServices(this IServiceCollection services, OpenSettingsConfiguration openSettingsConfiguration, ProviderInfo providerInfo)
        {
            ...
            services.AddSingleton<IAppConfigurationRestService, AppConfigurationRestService>();
            services.AddSingleton<IIdentifierRestService, IdentifierRestService>();
            services.AddSingleton<IInstanceRestService, AppInstanceRestService>();
            ...
            services.AddSingleton<ISettingClassRestService, AppSettingClassRestService>();
            services.AddSingleton<ISettingHistoryRestService, AppSettingHistoryRestService>();
            services.AddSingleton<IAppSettingRestService, AppSettingRestService>();
            services.AddSingleton<IAppTagRestService, AppTagRestService>();
