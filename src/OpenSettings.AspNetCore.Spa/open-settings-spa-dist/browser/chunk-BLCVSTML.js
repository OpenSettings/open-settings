...
import {
  ...
  MatToolbar,
  MatToolbarModule
} from "./chunk-5F4UL5JR.js";
import "./chunk-EB7MRBEE.js";
import "./chunk-PFZE6ICR.js";
import {
  MatSnackBar
...
var routes = [
  {
    ...
    children: [
      { path: DEFAULT_ROUTES.base, loadChildren: () => import("./chunk-DHU22MN4.js").then((m) => m.AppModule) },
      { path: DEFAULT_ROUTES.about, loadChildren: () => import("./chunk-ATKEIII3.js").then((m) => m.AboutModule) },
      { path: DEFAULT_ROUTES.groups, loadChildren: () => import("./chunk-V5IOVSRL.js").then((m) => m.GroupModule) },
      { path: DEFAULT_ROUTES.identifiers, loadChildren: () => import("./chunk-WMZOJSQY.js").then((m) => m.IdentifierModule) },
      { path: DEFAULT_ROUTES.tags, loadChildren: () => import("./chunk-BKDRQZHZ.js").then((m) => m.TagModule) },
      { path: DEFAULT_ROUTES.sponsors, loadChildren: () => import("./chunk-I43IB35R.js").then((m) => m.SponsorModule) },
...
//# sourceMappingURL=chunk-BLCVSTML.js.map
