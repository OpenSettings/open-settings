...
function ConfirmationDialogComponent_div_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5, "Type to confirm");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "input", 9);
    \u0275\u0275twoWayListener("ngModelChange", function ConfirmationDialogComponent_div_5_Template_input_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r1);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1('To confirm, type "', ctx_r1.data.confirmationText, '" below:');
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.userInput);
  }
}
var _ConfirmationDialogComponent = class _ConfirmationDialogComponent {
  constructor(dialogRef, data) {
    this.dialogRef = dialogRef;
    this.data = data;
    this.userInput = "";
    this.confirmationTextLowercase = "";
    this.data.confirmationText ??= "I confirm";
    this.confirmationTextLowercase = this.data.confirmationText.toLocaleLowerCase();
  }
  isInputMatching() {
    return this.userInput.toLocaleLowerCase() === this.confirmationTextLowercase || `${this.userInput.toLocaleLowerCase()}` === `"${this.confirmationTextLowercase}"`;
  }
  onConfirm() {
    this.dialogRef.close(true);
  }
};
_ConfirmationDialogComponent.\u0275fac = function ConfirmationDialogComponent_Factory(t) {
  return new (t || _ConfirmationDialogComponent)(\u0275\u0275directiveInject(MatDialogRef), \u0275\u0275directiveInject(MAT_DIALOG_DATA));
};
_ConfirmationDialogComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfirmationDialogComponent, selectors: [["ng-component"]], decls: 11, vars: 5, consts: [["mat-dialog-title", ""], ["mat-dialog-content", ""], [3, "innerHTML"], [3, "ngSubmit"], [4, "ngIf"], ["mat-dialog-actions", ""], ["mat-button", "", 3, "mat-dialog-close"], ["mat-raised-button", "", "color", "warn", "type", "submit", 3, "disabled"], ["appearance", "fill"], ["matInput", "", "name", "confirmationInput", 3, "ngModelChange", "ngModel"]], template: function ConfirmationDialogComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngSubmit", function ConfirmationDialogComponent_Template_form_ngSubmit_4_listener() {
      return ctx.onConfirm();
    });
    \u0275\u0275template(5, ConfirmationDialogComponent_div_5_Template, 7, 2, "div", 4);
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx.data.title || "Confirm");
    \u0275\u0275advance(2);
    \u0275\u0275property("innerHTML", ctx.data.message || "Are you sure?", \u0275\u0275sanitizeHtml);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx.data.requireConfirmation);
    \u0275\u0275advance(2);
    \u0275\u0275property("mat-dialog-close", false);
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx.data.requireConfirmation && !ctx.isInputMatching());
  }
}, dependencies: [NgIf, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, NgForm, MatDialogClose, MatDialogTitle, MatDialogActions, MatDialogContent, MatButton, MatFormField, MatLabel, MatInput], encapsulation: 2 });
var ConfirmationDialogComponent = _ConfirmationDialogComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfirmationDialogComponent, { className: "ConfirmationDialogComponent", filePath: "src\\app\\shared\\components\\confirmation-dialog\\confirmation-dialog.component.ts", lineNumber: 8 });
})();
...
//# sourceMappingURL=chunk-TGN3ATF3.js.map
