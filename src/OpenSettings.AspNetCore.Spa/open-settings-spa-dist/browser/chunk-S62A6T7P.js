...
function AboutComponent_mat_card_actions_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-card-actions", 17)(1, "a", 25);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("href", ctx_r2.viewReleaseNotes(ctx_r2.packInfo == null ? null : ctx_r2.packInfo.version), \u0275\u0275sanitizeUrl);
  }
}
...
function AboutComponent_mat_card_18_mat_card_actions_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("href", ctx_r2.viewReleaseNotes(ctx_r2.providerInfo == null ? null : ctx_r2.providerInfo.packInfo == null ? null : ctx_r2.providerInfo.packInfo.version), \u0275\u0275sanitizeUrl);
  }
}
...
var _AboutComponent = class _AboutComponent {
  ...
  viewReleaseNotes(version) {
    ...
    return this.releaseNotes.url.replace("%(MajorVersion)", majorVersion).replace("%(Version)", version);
  }
  upgradeLicense() {
...
_AboutComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AboutComponent, selectors: [["ng-component"]], decls: 42, vars: 8, consts: [[1, "px-3"], [1, "title", "mb-3"], [1, "mb-2"], [1, "card-title"], ["mat-table", "", 3, "dataSource"], ["matColumnDef", "key"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", "class", "font-weight-500 w-50", 4, "matCellDef"], ["matColumnDef", "value"], ["mat-cell", "", 4, "matCellDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["align", "end", 4, "ngIf"], ["class", "mt-3", 4, "ngIf"], [1, "mt-3"], [1, "card-title", "w-100", "d-flex"], [1, "spacer"], ["matIconPosition", "right", "fontIcon", "info", "matTooltip", "It shows the current license. Only active license will be shown here. If multiple licenses added, the highest edition with the longest expiry date takes precedence.", "matTooltipPosition", "below"], ["align", "end"], ["mat-button", "", "color", "primary mr-3", 3, "click"], ["mat-button", "", "color", "warn", 3, "click", 4, "ngIf"], [1, "footer", "justify-content-center", "d-flex", "text-muted", "p-3"], ["mat-header-cell", ""], ["mat-cell", "", 1, "font-weight-500", "w-50"], ["mat-cell", ""], ["mat-row", ""], ["mat-button", "", "color", "primary", "target", "_blank", 3, "href"], ["mat-button", "", "color", "warn", 3, "click"]], template: function AboutComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(39, "div", 20)(40, "span");
    \u0275\u0275text(41, "Copyright \xA9 2024 OpenSettings. All rights reserved.");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    \u0275\u0275advance(9);
...
//# sourceMappingURL=chunk-S62A6T7P.js.map
