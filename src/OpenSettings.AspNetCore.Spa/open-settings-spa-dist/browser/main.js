import {
  authGuard
} from "./chunk-WYC7PBTY.js";
import {
  UtilityService
} from "./chunk-BQ5XPJMT.js";
import "./chunk-IWQLQCFV.js";
import {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppComponent, { className: "AppComponent", filePath: "src\\app\\app\\app.component.ts", lineNumber: 7 });
})();

// src/app/core/guards/non-auth.guard.ts
var nonAuthGuard = (route, state) => {
...
var routes = [
  { path: "login", canActivateChild: [nonAuthGuard], loadChildren: () => import("./chunk-Q3A6QHP6.js").then((m) => m.LoginModule) },
  { path: "", canActivateChild: [authGuard], loadChildren: () => import("./chunk-PIVZED7W.js").then((m) => m.DefaultLayoutModule) },
  { path: "**", redirectTo: "" }
];
...
_AppRoutingModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [{ provide: LocationStrategy, useClass: HashLocationStrategy }], imports: [RouterModule.forRoot(routes), RouterModule] });
...
var _ErrorInterceptor = class _ErrorInterceptor {
  constructor(authService, utilityService) {
    ...
    return next.handle(request).pipe(catchError((error) => {
      switch (error.status) {
        case 401:
          ...
          break;
        case 0:
          this.utilityService.simpleErrorWithRestart(error.message, void 0, true);
          break;
        case 409:
          break;
        default:
...
_ErrorInterceptor.\u0275fac = function ErrorInterceptor_Factory(t) {
  return new (t || _ErrorInterceptor)(\u0275\u0275inject(AuthService), \u0275\u0275inject(UtilityService));
};
...
var _RequestInterceptor = class _RequestInterceptor {
  constructor(authService, windowService) {
    this.authService = authService;
...
_RequestInterceptor.\u0275fac = function RequestInterceptor_Factory(t) {
  return new (t || _RequestInterceptor)(\u0275\u0275inject(AuthService), \u0275\u0275inject(WindowService));
};
_RequestInterceptor.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _RequestInterceptor, factory: _RequestInterceptor.\u0275fac });
var RequestInterceptor = _RequestInterceptor;
