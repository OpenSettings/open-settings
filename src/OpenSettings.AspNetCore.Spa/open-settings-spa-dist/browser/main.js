...
var routes = [
  { path: "login", canActivateChild: [nonAuthGuard], loadChildren: () => import("./chunk-U4IOY4KV.js").then((m) => m.LoginModule) },
  { path: "", canActivateChild: [authGuard], loadChildren: () => import("./chunk-BJKVUDQF.js").then((m) => m.DefaultLayoutModule) },
  { path: "**", redirectTo: "" }
];
