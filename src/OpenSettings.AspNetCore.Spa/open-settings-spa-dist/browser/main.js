import {
  authGuard
} from "./chunk-UZ33AHTR.js";
import {
  UtilityService
} from "./chunk-PFZE6ICR.js";
import "./chunk-TRW2IRZZ.js";
import {
...
var routes = [
  { path: "login", canActivateChild: [nonAuthGuard], loadChildren: () => import("./chunk-HSG24GDN.js").then((m) => m.LoginModule) },
  { path: "", canActivateChild: [authGuard], loadChildren: () => import("./chunk-BLCVSTML.js").then((m) => m.DefaultLayoutModule) },
  { path: "**", redirectTo: "" }
];
...
_RequestInterceptor.\u0275fac = function RequestInterceptor_Factory(t) {
  return new (t || _RequestInterceptor)(\u0275\u0275inject(AuthService));
};
