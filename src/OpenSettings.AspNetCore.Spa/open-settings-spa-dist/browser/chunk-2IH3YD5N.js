...
var _TruncatePipe = class _TruncatePipe {
  transform(value, limit, includeEllipsis = true) {
    if (!value) {
      return "";
    }
...
_TruncatePipe.\u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({ name: "truncate", type: _TruncatePipe, pure: true });
...
_SharedModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [CommonModule] });
var SharedModule = _SharedModule;

// src/app/shared/layouts/default-layout/default-layout.service.ts
var _DefaultLayoutService = class _DefaultLayoutService {
...
_DefaultLayoutService.\u0275fac = function DefaultLayoutService_Factory(t) {
  return new (t || _DefaultLayoutService)(\u0275\u0275inject(UserPreferencesService));
};
_DefaultLayoutService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _DefaultLayoutService, factory: _DefaultLayoutService.\u0275fac, providedIn: "root" });
var DefaultLayoutService = _DefaultLayoutService;
...
var _ThemeService = class _ThemeService {
  constructor(userPreferencesService, windowService) {
    this.userPreferencesService = userPreferencesService;
    this.destroy$ = new Subject();
    this.initialEditionTheme = "";
    this.themes = Themes;
    const isDarkTheme = document.body.classList.contains(darkThemeClass);
    this.isDarkThemeSubject = new BehaviorSubject(isDarkTheme);
  ...
  getThemeInfo(themePreference) {
    switch (themePreference) {
      ...
      case "light":
        return LightTheme;
      case "system":
        return this.systemTheme === "dark" ? SystemDark : SystemLight;
      case "auto":
        return this.autoTheme === "dark" ? AutoDark : AutoLight;
    }
  }
  setEditionTheme(editionTheme) {
...
_ThemeService.\u0275fac = function ThemeService_Factory(t) {
  return new (t || _ThemeService)(\u0275\u0275inject(UserPreferencesService), \u0275\u0275inject(WindowService));
};
...
//# sourceMappingURL=chunk-2IH3YD5N.js.map
