...
// src/app/features/tag/components/tag-upsert/tag-upsert.component.ts
function TagUpsertComponent_button_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 13);
    \u0275\u0275listener("click", function TagUpsertComponent_button_8_Template_button_click_0_listener() {
      let tmp_2_0;
      \u0275\u0275restoreView(_r1);
...
var _TagUpsertComponent = class _TagUpsertComponent {
  constructor(snackBar, formBuilder, tagsService, dialog, dialogRef, model) {
  ...
  update(formValue) {
    if (formValue.id === "0") {
      ...
      const subscription2 = this.tagsService.createTag({
        body: {
          name: trimmedName,
    ...
    const updatetag = (formValue2, rowVersion) => {
    ...
    const handleUpdate = (formValue2, currentRowVersion) => {
      return updatetag(formValue2, currentRowVersion).pipe(switchMap((response) => {
        const responseData = response.data;
        if (!responseData && response.extras) {
          ...
          return this.dialog.open(ConflictResolverDialogComponent, {
            ...
            if (type === "Override") {
              ...
              return createtag(formValue2).pipe(switchMap(() => {
                return of(true);
              }));
            }
            return of(false);
...
_TagUpsertComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TagUpsertComponent, selectors: [["ng-component"]], decls: 34, vars: 9, consts: [[3, "formGroup"], ["mat-dialog-title", ""], [1, "pb-0"], ["appearance", "fill"], ["matInput", "", "formControlName", "name", 3, "maxLength"], ["mat-icon-button", "", "matSuffix", "", "type", "button", 3, "click", 4, "ngIf"], ["formControlName", "position", 3, "selectionChange"], [3, "value"], ["appearance", "fill", 3, "ngClass"], ["matInput", "", "formControlName", "sortOrder", "type", "number"], [1, "mt-1"], ["mat-button", "", "color", "accent", "mat-dialog-close", "", 1, "mr-1"], ["mat-raised-button", "", "color", "primary", 3, "click", "disabled"], ["mat-icon-button", "", "matSuffix", "", "type", "button", 3, "click"], ["fontIcon", "clear"]], template: function TagUpsertComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(7, "input", 4);
    \u0275\u0275template(8, TagUpsertComponent_button_8_Template, 2, 0, "button", 5);
    ...
    \u0275\u0275listener("selectionChange", function TagUpsertComponent_Template_mat_select_selectionChange_14_listener() {
    ...
    \u0275\u0275listener("click", function TagUpsertComponent_Template_button_click_32_listener() {
      return ctx.onSubmit();
    });
    \u0275\u0275text(33, "Save");
    \u0275\u0275elementEnd()()()();
...
var TagUpsertComponent = _TagUpsertComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TagUpsertComponent, { className: "TagUpsertComponent", filePath: "src\\app\\features\\tag\\components\\tag-upsert\\tag-upsert.component.ts", lineNumber: 15 });
})();

// src/app/features/tag/tag-routes.ts
var TAG_ROUTES = {
  base: "",
  create: "create",
  update: ":slug/update"
...
// src/app/features/tag/components/tag-list/tag-list.component.ts
var _c0 = ["searchTermInput"];
var _c1 = () => [8, 16, 32, 64];
var _c2 = () => ["./create"];
var _c3 = (a0) => [a0, "update"];
function TagListComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
...
function TagListComponent_button_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 31);
    \u0275\u0275listener("click", function TagListComponent_button_26_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function TagListComponent_mat_card_content_27_Template(rf, ctx) {
  if (rf & 1) {
...
function TagListComponent_th_30_Template(rf, ctx) {
  if (rf & 1) {
...
function TagListComponent_td_31_Template(rf, ctx) {
  if (rf & 1) {
...
function TagListComponent_th_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 33);
    \u0275\u0275text(1, "Name");
    \u0275\u0275elementEnd();
...
function TagListComponent_td_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 34);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function TagListComponent_th_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 33);
    \u0275\u0275text(1, "Sort Order");
    \u0275\u0275elementEnd();
...
function TagListComponent_td_37_button_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 37);
    \u0275\u0275listener("click", function TagListComponent_td_37_button_2_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
...
function TagListComponent_td_37_button_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 38);
    \u0275\u0275listener("click", function TagListComponent_td_37_button_3_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const data_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
...
function TagListComponent_td_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 34);
    \u0275\u0275text(1);
    \u0275\u0275template(2, TagListComponent_td_37_button_2_Template, 3, 0, "button", 35)(3, TagListComponent_td_37_button_3_Template, 3, 0, "button", 36);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function TagListComponent_th_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 33);
...
function TagListComponent_td_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 34);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function TagListComponent_th_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 33);
    \u0275\u0275text(1, "Created On");
    \u0275\u0275elementEnd();
...
function TagListComponent_td_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 34);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function TagListComponent_th_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 33);
    \u0275\u0275text(1, "Created By");
    \u0275\u0275elementEnd();
...
function TagListComponent_td_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 34);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function TagListComponent_th_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 33);
    \u0275\u0275text(1, "Updated On");
    \u0275\u0275elementEnd();
...
function TagListComponent_td_49_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 34);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function TagListComponent_th_51_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 33);
    \u0275\u0275text(1, "Updated By");
    \u0275\u0275elementEnd();
...
function TagListComponent_td_52_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 34);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function TagListComponent_th_54_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "th", 39);
  }
}
function TagListComponent_td_55_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function TagListComponent_td_55_Template_button_click_11_listener() {
...
function TagListComponent_tr_56_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 41);
  }
}
function TagListComponent_tr_57_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 42);
  }
}
function TagListComponent_mat_progress_bar_62_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-bar", 43);
  }
}
var _TagListComponent = class _TagListComponent {
  constructor(tagsService, dialog, snackBar, windowService, dummyComponentService, utilityService, userPreferencesService, route, router) {
    this.tagsService = tagsService;
    this.dialog = dialog;
    this.snackBar = snackBar;
...
_TagListComponent.\u0275fac = function TagListComponent_Factory(t) {
  return new (t || _TagListComponent)(\u0275\u0275directiveInject(TagsService), \u0275\u0275directiveInject(MatDialog), \u0275\u0275directiveInject(MatSnackBar), \u0275\u0275directiveInject(WindowService), \u0275\u0275directiveInject(DummyComponentService), \u0275\u0275directiveInject(UtilityService), \u0275\u0275directiveInject(UserPreferencesService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router));
};
_TagListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TagListComponent, selectors: [["ng-component"]], viewQuery: function TagListComponent_Query(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "span", 5);
    \u0275\u0275template(5, TagListComponent_button_5_Template, 3, 1, "button", 6);
    \u0275\u0275elementStart(6, "mat-menu", null, 0)(8, "button", 7);
    \u0275\u0275listener("click", function TagListComponent_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.deleteUnmappedTags());
    });
    ...
    \u0275\u0275listener("click", function TagListComponent_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function TagListComponent_Template_button_click_16_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("keyup", function TagListComponent_Template_input_keyup_24_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.applyFilter($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(26, TagListComponent_button_26_Template, 3, 0, "button", 10);
    \u0275\u0275elementEnd();
    \u0275\u0275template(27, TagListComponent_mat_card_content_27_Template, 2, 1, "mat-card-content", 11);
    \u0275\u0275elementStart(28, "table", 12);
    \u0275\u0275listener("cdkDropListDropped", function TagListComponent_Template_table_cdkDropListDropped_28_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.onRowDrop($event));
    });
    \u0275\u0275elementContainerStart(29, 13);
    \u0275\u0275template(30, TagListComponent_th_30_Template, 2, 0, "th", 14)(31, TagListComponent_td_31_Template, 2, 1, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(32, 16);
    \u0275\u0275template(33, TagListComponent_th_33_Template, 2, 0, "th", 14)(34, TagListComponent_td_34_Template, 2, 1, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(35, 17);
    \u0275\u0275template(36, TagListComponent_th_36_Template, 2, 0, "th", 14)(37, TagListComponent_td_37_Template, 4, 3, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(38, 18);
    \u0275\u0275template(39, TagListComponent_th_39_Template, 2, 0, "th", 14)(40, TagListComponent_td_40_Template, 2, 1, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(41, 19);
    \u0275\u0275template(42, TagListComponent_th_42_Template, 2, 0, "th", 14)(43, TagListComponent_td_43_Template, 3, 4, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(44, 20);
    \u0275\u0275template(45, TagListComponent_th_45_Template, 2, 0, "th", 14)(46, TagListComponent_td_46_Template, 2, 1, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(47, 21);
    \u0275\u0275template(48, TagListComponent_th_48_Template, 2, 0, "th", 14)(49, TagListComponent_td_49_Template, 3, 4, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(50, 22);
    \u0275\u0275template(51, TagListComponent_th_51_Template, 2, 0, "th", 14)(52, TagListComponent_td_52_Template, 2, 1, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(53, 23);
    \u0275\u0275template(54, TagListComponent_th_54_Template, 1, 0, "th", 24)(55, TagListComponent_td_55_Template, 16, 4, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275template(56, TagListComponent_tr_56_Template, 1, 0, "tr", 25)(57, TagListComponent_tr_57_Template, 1, 0, "tr", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "mat-paginator", 27);
    \u0275\u0275listener("page", function TagListComponent_Template_mat_paginator_page_58_listener($event) {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275text(61, "add");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(62, TagListComponent_mat_progress_bar_62_Template, 1, 0, "mat-progress-bar", 29);
...
var TagListComponent = _TagListComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TagListComponent, { className: "TagListComponent", filePath: "src\\app\\features\\tag\\components\\tag-list\\tag-list.component.ts", lineNumber: 28 });
})();

// src/app/features/tag/tag-routing.module.ts
var routes = [
  {
    path: TAG_ROUTES.base,
...
var _TagRoutingModule = class _TagRoutingModule {
};
_TagRoutingModule.\u0275fac = function TagRoutingModule_Factory(t) {
  return new (t || _TagRoutingModule)();
};
_TagRoutingModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _TagRoutingModule });
_TagRoutingModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [RouterModule.forChild(routes), RouterModule] });
var TagRoutingModule = _TagRoutingModule;

// src/app/features/tag/tag.module.ts
var _TagModule = class _TagModule {
};
_TagModule.\u0275fac = function TagModule_Factory(t) {
  return new (t || _TagModule)();
};
_TagModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _TagModule });
_TagModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [
  CommonModule,
  TagRoutingModule,
  DragDropModule,
  ReactiveFormsModule,
...
//# sourceMappingURL=chunk-P2FVCR37.js.map
