...
function SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_span_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_span_3_mat_icon_1_Template, 1, 1, "mat-icon", 30)(2, SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_span_3_ng_template_2_Template, 2, 1, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_mat_card_5_img_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 40);
  }
  if (rf & 2) {
    const sponsor_r7 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("src", sponsor_r7.imageUrl, \u0275\u0275sanitizeUrl)("alt", sponsor_r7.name + " IMG");
  }
}
function SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_mat_card_5_button_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 41);
    \u0275\u0275listener("click", function SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_mat_card_5_button_6_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r8);
      const sponsor_r7 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r3.confirmationRequiredToOpenLink(sponsor_r7.url, $event));
    });
...
function SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_mat_card_5_mat_icon_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const sponsor_r7 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("matTooltip", "From " + \u0275\u0275pipeBind2(1, 1, sponsor_r7.createdOn, "mediumDate"));
  }
}
function SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_mat_card_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-card", 33)(1, "div", 34);
    \u0275\u0275template(2, SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_mat_card_5_img_2_Template, 1, 2, "img", 35);
    \u0275\u0275elementStart(3, "div", 36)(4, "mat-card-content", 37);
    \u0275\u0275text(5);
    \u0275\u0275template(6, SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_mat_card_5_button_6_Template, 2, 0, "button", 38);
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(7, SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_mat_card_5_mat_icon_7_Template, 3, 4, "mat-icon", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const sponsor_r7 = ctx.$implicit;
    \u0275\u0275nextContext(3);
    const noImage_r9 = \u0275\u0275reference(49);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(6, _c0, !sponsor_r7.isActive));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", sponsor_r7.imageUrl)("ngIfElse", noImage_r9);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", sponsor_r7.name, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", sponsor_r7.url && sponsor_r7.isActive);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", sponsor_r7.isActive);
  }
}
function SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(3, SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_span_3_Template, 5, 3, "span", 26);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 27);
    \u0275\u0275template(5, SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_mat_card_5_Template, 8, 8, "mat-card", 28);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r3.selectedRawResponseData.classIdMappings[entry_r10.key]);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", entry_r10.value);
  }
}
function SponsorListComponent_mat_accordion_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-accordion", 23);
    \u0275\u0275template(1, SponsorListComponent_mat_accordion_37_mat_expansion_panel_1_Template, 6, 2, "mat-expansion-panel", 24);
    \u0275\u0275pipe(2, "keyvalue");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function SponsorListComponent_ng_template_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, SponsorListComponent_ng_template_38_button_0_Template, 3, 1, "button", 44);
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
...
function SponsorListComponent_a_46_mat_icon_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-icon", 49);
  }
  if (rf & 2) {
    const link_r12 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275propertyInterpolate("svgIcon", link_r12.iconName);
  }
}
function SponsorListComponent_a_46_ng_template_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const link_r12 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(link_r12.iconName !== "" ? link_r12.iconName : "favorite");
  }
}
function SponsorListComponent_a_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 47)(1, "span");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275template(3, SponsorListComponent_a_46_mat_icon_3_Template, 1, 1, "mat-icon", 48)(4, SponsorListComponent_a_46_ng_template_4_Template, 2, 1, "ng-template", null, 4, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const link_r12 = ctx.$implicit;
    const matIcon_r13 = \u0275\u0275reference(5);
    \u0275\u0275property("href", link_r12.url, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(link_r12.name);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", link_r12.svgIconDef)("ngIfElse", matIcon_r13);
  }
}
function SponsorListComponent_mat_progress_bar_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-bar", 50);
  }
}
function SponsorListComponent_ng_template_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 51);
  }
}
...
_SponsorListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SponsorListComponent, selectors: [["ng-component"]], viewQuery: function SponsorListComponent_Query(rf, ctx) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(12, SponsorListComponent_mat_option_12_Template, 2, 1, "mat-option", 11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "mat-form-field", 8)(14, "mat-label");
    \u0275\u0275text(15, "Filter by version");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "mat-select", 9, 0);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "mat-select", 9, 0);
    ...
    \u0275\u0275template(27, SponsorListComponent_mat_option_27_Template, 2, 2, "mat-option", 13);
    \u0275\u0275pipe(28, "keyvalue");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(29, SponsorListComponent_button_29_Template, 4, 0, "button", 14);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(37, SponsorListComponent_mat_accordion_37_Template, 3, 3, "mat-accordion", 18)(38, SponsorListComponent_ng_template_38_Template, 1, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(46, SponsorListComponent_a_46_Template, 6, 4, "a", 20);
    \u0275\u0275elementEnd();
    \u0275\u0275template(47, SponsorListComponent_mat_progress_bar_47_Template, 1, 0, "mat-progress-bar", 21)(48, SponsorListComponent_ng_template_48_Template, 1, 0, "ng-template", null, 3, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const noSponsors_r14 = \u0275\u0275reference(39);
    const sponsorMenu_r15 = \u0275\u0275reference(45);
    \u0275\u0275advance(8);
    ...
    \u0275\u0275advance(8);
    \u0275\u0275property("ngIf", ctx.hasAnySponsors)("ngIfElse", noSponsors_r14);
    \u0275\u0275advance(3);
    \u0275\u0275property("matMenuTriggerFor", ctx.selectedRawResponseData.becomeSponsorLinks.length > 1 ? sponsorMenu_r15 : null);
    \u0275\u0275advance(6);
...
//# sourceMappingURL=chunk-K42O2XVC.js.map
