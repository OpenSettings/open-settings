...
// src/app/shared/components/conflict-resolver-dialog/conflict-resolver-dalog.module.ts
var _ConflictResolverDialogModule = class _ConflictResolverDialogModule {
};
_ConflictResolverDialogModule.\u0275fac = function ConflictResolverDialogModule_Factory(t) {
  return new (t || _ConflictResolverDialogModule)();
};
_ConflictResolverDialogModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _ConflictResolverDialogModule });
_ConflictResolverDialogModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [
  CommonModule,
  FormsModule,
  MatDialogModule,
  MatButtonModule,
...
var ConflictResolverDialogModule = _ConflictResolverDialogModule;

// src/app/features/identifier/identifier-routes.ts
var SETTING_IDENTIFIER_ROUTES = {
  base: "",
  create: "create",
  update: ":slug/update"
};

// src/app/features/identifier/components/identifier-upsert/identifier-upsert.component.ts
function IdentifierUpsertComponent_button_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 13);
    \u0275\u0275listener("click", function IdentifierUpsertComponent_button_8_Template_button_click_0_listener() {
      let tmp_2_0;
      \u0275\u0275restoreView(_r1);
...
var _IdentifierUpsertComponent = class _IdentifierUpsertComponent {
  constructor(snackBar, formBuilder, identifiersService, dialog, dialogRef, model) {
  ...
  update(formValue) {
    if (formValue.id === "0") {
      ...
      const subscription2 = this.identifiersService.createIdentifier({
        body: {
          name: trimmedName,
    ...
    const updateIdentifier = (formValue2, rowVersion) => {
      return this.identifiersService.updateIdentifier({
        identifierId: formValue2.id,
        body: {
    ...
    const createIdentifier = (formValue2) => {
    ...
    const handleUpdate = (formValue2, currentRowVersion) => {
      return updateIdentifier(formValue2, currentRowVersion).pipe(switchMap((response) => {
        const responseData = response.data;
        if (!responseData && response.extras) {
          ...
          return this.dialog.open(ConflictResolverDialogComponent, {
            ...
            if (type === "Override") {
              ...
              return createIdentifier(formValue2).pipe(switchMap(() => {
                return of(true);
              }));
            }
            return of(false);
...
_IdentifierUpsertComponent.\u0275fac = function IdentifierUpsertComponent_Factory(t) {
  return new (t || _IdentifierUpsertComponent)(\u0275\u0275directiveInject(MatSnackBar), \u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(IdentifiersService), \u0275\u0275directiveInject(MatDialog), \u0275\u0275directiveInject(MatDialogRef), \u0275\u0275directiveInject(MAT_DIALOG_DATA));
};
_IdentifierUpsertComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _IdentifierUpsertComponent, selectors: [["app-identifier-upsert"]], decls: 34, vars: 9, consts: [[3, "formGroup"], ["mat-dialog-title", ""], [1, "pb-0"], ["appearance", "fill"], ["matInput", "", "formControlName", "name", 3, "maxLength"], ["mat-icon-button", "", "matSuffix", "", "type", "button", 3, "click", 4, "ngIf"], ["formControlName", "position", 3, "selectionChange"], [3, "value"], ["appearance", "fill", 3, "ngClass"], ["matInput", "", "formControlName", "sortOrder", "type", "number"], [1, "mt-1"], ["mat-button", "", "color", "accent", "mat-dialog-close", "", 1, "mr-1"], ["mat-raised-button", "", "color", "primary", 3, "click", "disabled"], ["mat-icon-button", "", "matSuffix", "", "type", "button", 3, "click"], ["fontIcon", "clear"]], template: function IdentifierUpsertComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(7, "input", 4);
    \u0275\u0275template(8, IdentifierUpsertComponent_button_8_Template, 2, 0, "button", 5);
    ...
    \u0275\u0275listener("selectionChange", function IdentifierUpsertComponent_Template_mat_select_selectionChange_14_listener() {
    ...
    \u0275\u0275listener("click", function IdentifierUpsertComponent_Template_button_click_32_listener() {
      return ctx.onSubmit();
    });
    \u0275\u0275text(33, "Save");
    \u0275\u0275elementEnd()()()();
...
var IdentifierUpsertComponent = _IdentifierUpsertComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(IdentifierUpsertComponent, { className: "IdentifierUpsertComponent", filePath: "src\\app\\features\\identifier\\components\\identifier-upsert\\identifier-upsert.component.ts", lineNumber: 16 });
})();

// src/app/features/identifier/components/identifier-list/identifier-list.component.ts
var _c0 = ["searchTermInput"];
var _c1 = () => [8, 16, 32, 64];
var _c2 = () => ["./create"];
var _c3 = (a0) => [a0, "update"];
function IdentifierListComponent_button_5_Template(rf, ctx) {
  if (rf & 1) {
...
function IdentifierListComponent_button_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 31);
    \u0275\u0275listener("click", function IdentifierListComponent_button_26_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
...
function IdentifierListComponent_mat_card_content_27_Template(rf, ctx) {
  if (rf & 1) {
...
function IdentifierListComponent_th_30_Template(rf, ctx) {
  if (rf & 1) {
...
function IdentifierListComponent_td_31_Template(rf, ctx) {
  if (rf & 1) {
...
function IdentifierListComponent_th_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 33);
    \u0275\u0275text(1, "Name");
    \u0275\u0275elementEnd();
...
function IdentifierListComponent_td_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 34);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function IdentifierListComponent_th_36_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 33);
    \u0275\u0275text(1, "Sort Order");
    \u0275\u0275elementEnd();
...
function IdentifierListComponent_td_37_button_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 37);
    \u0275\u0275listener("click", function IdentifierListComponent_td_37_button_2_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
...
function IdentifierListComponent_td_37_button_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 38);
    \u0275\u0275listener("click", function IdentifierListComponent_td_37_button_3_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r9);
      const data_r8 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
...
function IdentifierListComponent_td_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 34);
    \u0275\u0275text(1);
    \u0275\u0275template(2, IdentifierListComponent_td_37_button_2_Template, 3, 0, "button", 35)(3, IdentifierListComponent_td_37_button_3_Template, 3, 0, "button", 36);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function IdentifierListComponent_th_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 33);
...
function IdentifierListComponent_td_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 34);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function IdentifierListComponent_th_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 33);
    \u0275\u0275text(1, "Created On");
    \u0275\u0275elementEnd();
...
function IdentifierListComponent_td_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 34);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function IdentifierListComponent_th_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 33);
    \u0275\u0275text(1, "Created By");
    \u0275\u0275elementEnd();
...
function IdentifierListComponent_td_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 34);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function IdentifierListComponent_th_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 33);
    \u0275\u0275text(1, "Updated On");
    \u0275\u0275elementEnd();
...
function IdentifierListComponent_td_49_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 34);
    \u0275\u0275text(1);
    \u0275\u0275pipe(2, "date");
...
function IdentifierListComponent_th_51_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 33);
    \u0275\u0275text(1, "Updated By");
    \u0275\u0275elementEnd();
...
function IdentifierListComponent_td_52_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 34);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function IdentifierListComponent_th_54_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "th", 39);
  }
}
function IdentifierListComponent_td_55_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function IdentifierListComponent_td_55_Template_button_click_11_listener() {
...
function IdentifierListComponent_tr_56_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 41);
  }
}
function IdentifierListComponent_tr_57_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 42);
  }
}
function IdentifierListComponent_mat_progress_bar_62_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "mat-progress-bar", 43);
  }
}
var _IdentifierListComponent = class _IdentifierListComponent {
  constructor(identifiersService, dialog, snackBar, windowService, dummyComponentService, utilityService, userPreferencesService, route, router) {
    this.identifiersService = identifiersService;
    this.dialog = dialog;
    this.snackBar = snackBar;
  ...
  delete(model) {
    ...
    const subscription = this.dialog.open(ConfirmationDialogComponent, {
      ...
      if (result) {
        const internalSubscription = this.identifiersService.deleteIdentifier({ identifierId: model.id, rowVersion: model.rowVersion }).subscribe((response) => {
  ...
  add() {
    const identifierEditComponentModel = {
      id: "0",
      name: "",
      sortOrder: 0,
      rowVersion: ""
...
_IdentifierListComponent.\u0275fac = function IdentifierListComponent_Factory(t) {
  return new (t || _IdentifierListComponent)(\u0275\u0275directiveInject(IdentifiersService), \u0275\u0275directiveInject(MatDialog), \u0275\u0275directiveInject(MatSnackBar), \u0275\u0275directiveInject(WindowService), \u0275\u0275directiveInject(DummyComponentService), \u0275\u0275directiveInject(UtilityService), \u0275\u0275directiveInject(UserPreferencesService), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router));
};
_IdentifierListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _IdentifierListComponent, selectors: [["ng-component"]], viewQuery: function IdentifierListComponent_Query(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function IdentifierListComponent_Template_button_click_12_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("click", function IdentifierListComponent_Template_button_click_16_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275listener("keyup", function IdentifierListComponent_Template_input_keyup_24_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.applyFilter($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(26, IdentifierListComponent_button_26_Template, 3, 0, "button", 10);
    \u0275\u0275elementEnd();
    \u0275\u0275template(27, IdentifierListComponent_mat_card_content_27_Template, 2, 1, "mat-card-content", 11);
    \u0275\u0275elementStart(28, "table", 12);
    \u0275\u0275listener("cdkDropListDropped", function IdentifierListComponent_Template_table_cdkDropListDropped_28_listener($event) {
      \u0275\u0275restoreView(_r1);
      return \u0275\u0275resetView(ctx.onRowDrop($event));
    });
    \u0275\u0275elementContainerStart(29, 13);
    \u0275\u0275template(30, IdentifierListComponent_th_30_Template, 2, 0, "th", 14)(31, IdentifierListComponent_td_31_Template, 2, 1, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(32, 16);
    \u0275\u0275template(33, IdentifierListComponent_th_33_Template, 2, 0, "th", 14)(34, IdentifierListComponent_td_34_Template, 2, 1, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(35, 17);
    \u0275\u0275template(36, IdentifierListComponent_th_36_Template, 2, 0, "th", 14)(37, IdentifierListComponent_td_37_Template, 4, 3, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(38, 18);
    \u0275\u0275template(39, IdentifierListComponent_th_39_Template, 2, 0, "th", 14)(40, IdentifierListComponent_td_40_Template, 2, 1, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(41, 19);
    \u0275\u0275template(42, IdentifierListComponent_th_42_Template, 2, 0, "th", 14)(43, IdentifierListComponent_td_43_Template, 3, 4, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(44, 20);
    \u0275\u0275template(45, IdentifierListComponent_th_45_Template, 2, 0, "th", 14)(46, IdentifierListComponent_td_46_Template, 2, 1, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(47, 21);
    \u0275\u0275template(48, IdentifierListComponent_th_48_Template, 2, 0, "th", 14)(49, IdentifierListComponent_td_49_Template, 3, 4, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(50, 22);
    \u0275\u0275template(51, IdentifierListComponent_th_51_Template, 2, 0, "th", 14)(52, IdentifierListComponent_td_52_Template, 2, 1, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275elementContainerStart(53, 23);
    \u0275\u0275template(54, IdentifierListComponent_th_54_Template, 1, 0, "th", 24)(55, IdentifierListComponent_td_55_Template, 16, 4, "td", 15);
    \u0275\u0275elementContainerEnd();
    \u0275\u0275template(56, IdentifierListComponent_tr_56_Template, 1, 0, "tr", 25)(57, IdentifierListComponent_tr_57_Template, 1, 0, "tr", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "mat-paginator", 27);
    \u0275\u0275listener("page", function IdentifierListComponent_Template_mat_paginator_page_58_listener($event) {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275text(61, "add");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(62, IdentifierListComponent_mat_progress_bar_62_Template, 1, 0, "mat-progress-bar", 29);
...
var IdentifierListComponent = _IdentifierListComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(IdentifierListComponent, { className: "IdentifierListComponent", filePath: "src\\app\\features\\identifier\\components\\identifier-list\\identifier-list.component.ts", lineNumber: 28 });
})();

// src/app/features/identifier/identifier-routing.module.ts
var routes = [
  {
    path: SETTING_IDENTIFIER_ROUTES.base,
...
var _IdentifierRoutingModule = class _IdentifierRoutingModule {
};
_IdentifierRoutingModule.\u0275fac = function IdentifierRoutingModule_Factory(t) {
  return new (t || _IdentifierRoutingModule)();
};
_IdentifierRoutingModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _IdentifierRoutingModule });
_IdentifierRoutingModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [RouterModule.forChild(routes), RouterModule] });
var IdentifierRoutingModule = _IdentifierRoutingModule;

// src/app/features/identifier/identifier.module.ts
var _IdentifierModule = class _IdentifierModule {
};
_IdentifierModule.\u0275fac = function IdentifierModule_Factory(t) {
  return new (t || _IdentifierModule)();
};
_IdentifierModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _IdentifierModule });
_IdentifierModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [
  CommonModule,
...
var IdentifierModule = _IdentifierModule;
export {
  IdentifierModule
};
//# sourceMappingURL=chunk-QDKUB2RK.js.map
