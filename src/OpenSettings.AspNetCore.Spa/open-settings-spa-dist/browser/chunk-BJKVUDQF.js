...
import {
  MatDivider,
  MatDividerModule
} from "./chunk-W6BDDF2S.js";
import {
  LicenseUpgradeComponent,
  LicensesService,
  MatToolbar,
  MatToolbarModule
} from "./chunk-FB3CSAEE.js";
import "./chunk-EB7MRBEE.js";
import "./chunk-LVGOKEOT.js";
import {
  MatSnackBar
...
var routes = [
  {
    ...
    children: [
      { path: DEFAULT_ROUTES.base, loadChildren: () => import("./chunk-US6FDA5R.js").then((m) => m.AppModule) },
      { path: DEFAULT_ROUTES.about, loadChildren: () => import("./chunk-IWWUTJZC.js").then((m) => m.AboutModule) },
      { path: DEFAULT_ROUTES.groups, loadChildren: () => import("./chunk-MF3ARVJ3.js").then((m) => m.GroupModule) },
      { path: DEFAULT_ROUTES.identifiers, loadChildren: () => import("./chunk-K4CZXDMC.js").then((m) => m.IdentifierModule) },
      { path: DEFAULT_ROUTES.tags, loadChildren: () => import("./chunk-AE55KZH4.js").then((m) => m.TagModule) },
      { path: DEFAULT_ROUTES.sponsors, loadChildren: () => import("./chunk-35B4HB2M.js").then((m) => m.SponsorModule) },
...
//# sourceMappingURL=chunk-BJKVUDQF.js.map
